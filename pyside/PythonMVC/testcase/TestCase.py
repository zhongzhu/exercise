...
class StepFunction(Step):
    ...
    def load(self, node, parentStep):
        ...
        #Arguments, Variable, RespmappingList
...
class TestCase(object):
    ...
    classdocs
    '''
    def __init__(self, tcFileName = 'a.xml'):
        '''
        Constructor
        '''
